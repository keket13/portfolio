    ...
    <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row py-16">
        ...
        <div class="flex flex-col justify-between xl:w-5/12">
            ...
            <div class="sm:text-center lg:py-12 lg:text-left xl:py-24">
                ...
                <h1 class="mb-8 text-4xl font-bold text-cyan-700 sm:text-5xl md:mb-12">Keth Elden Mondejar.</h1>

                <h1 class="mb-8 text-4xl text-cyan-700 md:mb-12">Im an IT student from Cordova Public College. This is my Portfolio.</h1>
